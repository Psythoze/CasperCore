...
_global.dofus["\r\x14"].gapi.ui.PanelPrestigeDesc = function()
{
   super();
};
dofus["\r\x14"].gapi.ui.PanelPrestigeDesc.prototype = new ank.gapi.core["\x1e\n\r"]();
var _loc1 = _global.dofus["\r\x14"].gapi.ui.PanelPrestigeDesc.prototype;
_loc1.init = function()
{
   super.init(false,dofus["\r\x14"].gapi.ui.PanelPrestigeDesc.CLASS_NAME);
};
...
{
   this._bg.title = "Panel Bonus Prestige 1";
...
_loc1.click = function(oEvent)
{
   ...
   {
      this.gapi.unloadUIComponent("PanelPrestigeDesc1");
   }
   _loc3_ = oEvent.target;
...
_loc1.playerInfo = "";
_global.dofus["\r\x14"].gapi.ui.PanelPrestigeDesc.CLASS_NAME = "PanelPrestigeDesc1";
