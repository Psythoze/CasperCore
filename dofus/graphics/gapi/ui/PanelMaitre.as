...
_loc1.initData = function()
{
   ...
   this._lblFarm.text = "Activer/Désactiver Mode Maitre";
   ...
   this._btnAFarm.selected = _loc2_.getOption("Maitre");
...
_loc1.click = function(oEvent)
{
   ...
   {
      this.api.kernel.Console.process(".windows");
   }
   _loc3_ = oEvent.target;
   ...
   {
      this.api.kernel.Console.process(".ipkamas");
   }
   _loc3_ = oEvent.target;
