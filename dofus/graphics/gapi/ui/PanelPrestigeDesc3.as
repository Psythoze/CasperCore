...
_global.dofus["\r\x14"].gapi.ui.PanelPrestigeDesc3 = function()
{
   super();
};
dofus["\r\x14"].gapi.ui.PanelPrestigeDesc3.prototype = new ank.gapi.core["\x1e\n\r"]();
var _loc1 = _global.dofus["\r\x14"].gapi.ui.PanelPrestigeDesc3.prototype;
_loc1.init = function()
{
   super.init(false,dofus["\r\x14"].gapi.ui.PanelPrestigeDesc3.CLASS_NAME);
};
...
{
   this._bg.title = "Panel Bonus Prestige 3";
...
_loc1.click = function(oEvent)
{
   ...
   {
      this.gapi.unloadUIComponent("PanelPrestigeDesc3");
   }
   _loc3_ = oEvent.target;
...
_loc1.playerInfo = "";
_global.dofus["\r\x14"].gapi.ui.PanelPrestigeDesc3.CLASS_NAME = "PanelPrestigeDesc3";
