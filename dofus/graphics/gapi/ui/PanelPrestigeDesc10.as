...
_global.dofus["\r\x14"].gapi.ui.PanelPrestigeDesc10 = function()
{
   super();
};
dofus["\r\x14"].gapi.ui.PanelPrestigeDesc10.prototype = new ank.gapi.core["\x1e\n\r"]();
var _loc1 = _global.dofus["\r\x14"].gapi.ui.PanelPrestigeDesc10.prototype;
_loc1.init = function()
{
   super.init(false,dofus["\r\x14"].gapi.ui.PanelPrestigeDesc10.CLASS_NAME);
};
...
{
   this._bg.title = "Panel Bonus Prestige 10";
...
_loc1.click = function(oEvent)
{
   ...
   {
      this.gapi.unloadUIComponent("PanelPrestigeDesc10");
   }
   _loc3_ = oEvent.target;
...
_loc1.playerInfo = "";
_global.dofus["\r\x14"].gapi.ui.PanelPrestigeDesc10.CLASS_NAME = "PanelPrestigeDesc10";
Object.registerClass("UI_PanelPrestigeDesc10",dofus["\r\x14"].gapi.ui.PanelPrestigeDesc10);
