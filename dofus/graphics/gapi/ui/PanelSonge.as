...
_loc1.addListeners = function()
{
   ...
   this._mcRestart.addEventListener("click",this);
   this._mcRestart.addEventListener("over",this);
   this._mcRestart.addEventListener("out",this);
...
{
   this._btnAcW.text = "Téléporter au songe";
   this._bg.title = "Panel Songe";
   this._btnPass.label = "Activer/Désac";
   this._btnOneW.label = "Continuer";
...
_loc1.initData = function()
{
   ...
   this._lblinfos.text = "Afin de commencer ou continuer vos songes, veuillez cliquer sur continuer... Bonne chance dans l\'obscuritée !";
...
{
   this._lblprestige2.text = String("Songes " + _loc2_);
};
_loc1.initSonge = function(_loc55_)
{
   this._lblSonge.text = String("Songes " + _loc55_);
};
...
_loc1.click = function(oEvent)
{
   ...
   {
      this.gapi.unloadUIComponent("PanelSonge");
   }
   _loc3_ = oEvent.target;
